<div class="row">
    <div class="col-xl-12">
        <div class="page-title-box">
            <h4 class="page-title text-muted float-left"><?= $page_title ?></h4>

            <ol class="breadcrumb float-right">
                <li class="breadcrumb-item"><a href="#">Trang chủ</a></li>
                <li class="breadcrumb-item"><a href="#">Quản lý điện thoại</a></li>
                <li class="breadcrumb-item active">Sửa thông tin điện thoại</li>
            </ol>
...
<div class="card-box">
    <form action="?ctrl=dienthoai&act=update" method="post" enctype="multipart/form-data">
        <div class="row align-items-center">
            <div class="col  m-b-0 ">
                <h5 class="text-custom "><i class="zmdi zmdi-border-color mr-2"></i> Kiểm tra và sửa dữ liệu cho sản
                    phẩm</h5>
            </div>
        ...
        <div class="card m-b-20">
            <div class="card-header d-flex justify-content-between">
                ...
                <div>
                    ...
                    <?php
                    if ($DT_detail['Hot'] == 1) $checked_hot = "checked";
                    else $checked_hot = "";
                    ?>
                    <input type="checkbox" <?= $checked_hot ?> data-plugin="switchery" data-size="small" name="hot" data-color="red"/>
                    <label for="anhien" class="form-control-label text-rightml-5 mr-2">Hiển thị:</label>
                    <?php
                    if ($DT_detail['AnHien'] == 1) $checked_anhien = "checked";
                    else $checked_anhien = "";
                    ?>
            ...
            <div class="card-body">
                    ...
                    <div class="col-sm-9">
                        <select id="nhasanxuat" name="idNSX" required class="custom-select w-50">
                            ...
                            <?php
                                    ...
                                    foreach ($nhasanxuat as $row) {
                                        if ($DT_detail['idNSX'] == $row['idNSX']) $selected = "selected";
                                        else $selected = "";
                                ?>
                                <option value="<?= $row['idNSX'] ?>" <?=$selected?> > <?=$row['TenNSX']?></option>
                            <?php } ?>
                        </select>
                ...
                <div class="form-group row">
                    <label for="tensanpham" class="col-sm-3 form-control-label text-right">Tên sản phẩm<span
                                class="text-danger">*</span>:</label>
                    <div class="col-sm-9">
                        <input class="form-control" type="text" value="<?= $DT_detail['TenDT'] ?>" name="TenDT"
                               placeholder="Redmi Note 9s 4G 64GB"
                               id="tensanpham">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" id="ckeditor" rows="3" name="mota"><?= $DT_detail['MoTa'] ?></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" type="number" placeholder="42000" id="SoLuongTonKho"
                               name="SoLuongTonKho" value="<?= $DT_detail['SoLuongTonKho'] ?>">
                    </div>
                </div>
                <div class="form-group row">
                        ...
                        <div class="card-box border">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="file" id="urlHinh" name="urlHinh" class="dropify" data-default-file="<?=PATHIMG_DT.$DT_detail['urlHinh']?>" data-height="450"/>
                                </div>
                                <div class="col-md-6">
            ...
            <div class="card-body row">
                <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="6.8 inches"
                               value="<?= $TTDT_detail['ManHinh'] ?>" id="ManHinh" name="ManHinh">
                    </div>
                    <div class="form-group">
                        ...
                        <select id="HeDieuHanh" name="HeDieuHanh" class="custom-select  ">
                            ...
                            <option <?php if ($TTDT_detail['HeDieuHanh'] == "Android") echo("selected"); ?>
                                    value="Android">Android
                            </option>
                            <option <?php if ($TTDT_detail['HeDieuHanh'] == "IOS") echo("selected"); ?> value="IOS">IOS
                            </option>
                            <option <?php if ($TTDT_detail['HeDieuHanh'] == "Window Phone") echo("selected"); ?>
                                    value="Window Phone">Window Phone
                            </option>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select id="RAM" name="RAM" class="custom-select  ">
                            ...
                            <option <?php if ($TTDT_detail['RAM'] == "2 GB") echo("selected"); ?> value="2 GB">2 GB
                            </option>
                            <option <?php if ($TTDT_detail['RAM'] == "4 GB") echo("selected"); ?> value="4 GB">4 GB
                            </option>
                            <option <?php if ($TTDT_detail['RAM'] == "6 GB") echo("selected"); ?> value="6 GB">6 GB
                            </option>
                            <option <?php if ($TTDT_detail['RAM'] == "8 GB") echo("selected"); ?> value="8 GB">8 GB
                            </option>
                            <option <?php if ($TTDT_detail['RAM'] == "16 GB") echo("selected"); ?> value="16 GB">16 GB
                            </option>
                            <option <?php if ($TTDT_detail['RAM'] == "32 GB") echo("selected"); ?> value="32 GB">32 GB
                            </option>
                            <option <?php if ($TTDT_detail['RAM'] == "64 GB") echo("selected"); ?> value="64 GB">64 GB
                            </option>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select id="TheSim" name="TheSim" class="custom-select  ">
                            <option <?php if ($TTDT_detail['TheSim'] == "1 SIM (Nano-SIM)") echo("selected"); ?>
                                    value="1 SIM (Nano-SIM)">1 SIM (Nano-SIM)
                            </option>
                            <option <?php if ($TTDT_detail['TheSim'] == "2 SIM (Nano-SIM)") echo("selected"); ?>
                                    value="2 SIM (Nano-SIM)" selected>2 SIM (Nano-SIM)
                            </option>
                        </select>
                    </div>
                </div>
                <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="44 MP, F/2.4, Cảm biến thông minh AI"
                               id="CameraTruoc" name="CameraTruoc" value="<?= $TTDT_detail['CameraTruoc'] ?>">
                    </div>
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="64 MP + 8 MP + 2 MP + 2 MP" id="CameraSau"
                               name="CameraSau" value="<?= $TTDT_detail['CameraSau'] ?>">
                    </div>
                    <div class="form-group">
                        ...
                        <select id="BoNhoTrong" name="BoNhoTrong" class="custom-select  ">
                            ...
                            <option <?php if ($TTDT_detail['BoNhoTrong'] == "8GB") echo("selected"); ?> value="8 GB">8
                                GB
                            </option>
                            <option <?php if ($TTDT_detail['BoNhoTrong'] == "16GB") echo("selected"); ?> value="16 GB">16
                                GB
                            </option>
                            <option <?php if ($TTDT_detail['BoNhoTrong'] == "32GB") echo("selected"); ?> value="32 GB">32
                                GB
                            </option>
                            <option <?php if ($TTDT_detail['BoNhoTrong'] == "64GB") echo("selected"); ?> value="64 GB">64
                                GB
                            </option>
                            <option <?php if ($TTDT_detail['BoNhoTrong'] == "128GB") echo("selected"); ?> value="128 GB">
                                128 GB
                            </option>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Li-Po 4500 mAh battery, Fast charging 18W"
                               id="DungLuongPin" name="DungLuongPin" value="<?= $TTDT_detail['DungLuongPin'] ?>">
                    </div>
                    <div class="form-group">
                        ...
                        <select id="TheNho" name="TheNho" class="custom-select  ">
                            ...
                            <option <?php if ($TTDT_detail['TheNho'] == "8GB") echo("selected"); ?> value="8 GB">8 GB
                            </option>
                            <option <?php if ($TTDT_detail['TheNho'] == "16GB") echo("selected"); ?> value="16 GB">16 GB
                            </option>
                            <option <?php if ($TTDT_detail['TheNho'] == "32GB") echo("selected"); ?> value="32 GB">32 GB
                            </option>
                            <option <?php if ($TTDT_detail['TheNho'] == "64GB") echo("selected"); ?> value="64 GB">64 GB
                            </option>
                            <option <?php if ($TTDT_detail['TheNho'] == "128GB") echo("selected"); ?> value="128 GB">128
                                GB
                            </option>
                        </select>
                    </div>
